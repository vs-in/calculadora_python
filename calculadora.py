from tkinter import Tk, Entry, Button, StringVar  #--> Importaciones

digito = ""   #---> Variable control
...
boton_borrar = Button(ventana, text="C", fg="black", bg="white", height=3 , width=7, command= lambda: limpiar_completo())
...
boton_igual = Button(ventana, text="=", fg="black", bg="white", height=3 , width=16,command=resultado)
